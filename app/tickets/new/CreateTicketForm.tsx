    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-2">New Ticket</h1>
        </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {warning && (
                <div className="p-3 bg-orange-50 border border-orange-200 rounded text-sm text-orange-700 font-medium">
                  ⚠ {warning}
                </div>
              )}
